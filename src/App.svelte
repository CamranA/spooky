...
<main>
  <div class="container">
    <header>
      <h1 class="myTitle">This will be our haunted game</h1>
    </header>

    <div class="mainStuff">
      <p>Hexagon asymmetrical cloud bread art party truffaut. Ugh cliche tilde thundercats butcher meditation prism bicycle
